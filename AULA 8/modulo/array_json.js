...
const percorrendoArray = function(){
    ...
    //FOREaCH
    // listaDeprotudos.forEach(function (produto, indice){
    //     console.log(indice + '- Nome do produto: '+ produto)
    // })

    //Retorna indice do elemento que foi encontrado 
    //Caso não exista o item buscado retorna -1 
    console.log(listaDeprotudos.indexOf('Impressora'))
    console.log(listaDeprotudos.indexOf('impressora'))

    // Retorna verdadeiro ou falso
    console.log(listaDeprotudos.includes('Mouse'))
}
percorrendoArray()

console.log('°•°•°•°•°•°•°•°••°•°•°•°•°•°•°•°•°•°•°•°•°•°•°•°•°•°•°')
const filtroProdutos = function(nomeProduto){

    let listaDeprodudos = ['Mouse','Teclado','Monitor','Impressora', 'Mouse Pad','Gabinete','Processador','HD']
    let nome = String(nomeProduto)

    // return listaDeprodudos.includes(nome)


    let status = false

    listaDeprodudos.forEach(function(produto){
        if(produto.toUpperCase() == nome.toUpperCase())
        status = true
    })

    // if(listaDeprodudos.indexOf(nome)>= 0)
    //     status = true
    // else
    //     status = false
...
console.log(filtroProdutos('mouse'))
